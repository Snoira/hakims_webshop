...
const ProductForm = ({ product, categoryList, submitFunction, setEditMode, deleteFunction }) => {
    ...
    return (
        <div className="mx-auto border p-3 ">
            ...
            {product &&
                <ConfirmDeleteModal deleteFunction={deleteFunction} setQuestionDelete={setQuestionDelete} questionDelete={questionDelete} object={product} />
            }
        </div>
    )
}
