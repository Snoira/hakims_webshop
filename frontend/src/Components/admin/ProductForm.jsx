...
const ProductForm = ({
  ...
  const validationSchema = Yup.object({
    ...
    comparisonPrice: Yup.string().required("Required"),
  ...
  return (
    <div className="mx-auto border p-3 ">
      {product ? (
        ...
        <h2 className="text-center mb-4 mt-1">Create Product</h2>
      )}
      <form
      ...
      >
        <div className="row justify-content-center align-items-center mb-2 mt-3">
          <div className="col-5">
            ...
            <input
              ...
              placeholder={product ? `${product.name}` : "Namn på produkt"}
          ...
          <div className="col-5">
            ...
            <input
              ...
              placeholder={product ? `${product.brand}` : "Märke på produkt"}
        ...
        <div className="row justify-content-center align-items-center mb-2">
          <div className="col-5">
            ...
            <input
              ...
              placeholder={product ? `${product.imageURL}` : "Produktbild URL"}
          ...
          <div className="col-5">
            ...
            >
              {" "}
              {/*defaultValue={product ? `${product.category.name}`: "Kategori på produkt"}*/}
              {product ? (
                <option hidden value={product.category._id}>
        ...
        <div className="row justify-content-center align-items-center mb-2">
          <div className="col-3">
            ...
            <input
              ...
              placeholder={product ? `${product.price}` : "Pris"}
          ...
          <div className="col-3">
            ...
            <input
              ...
              placeholder={product ? `${formik.values.amount}` : "Mängd"}
              {...formik.getFieldProps("amount")}
            />
          </div>
          <div className="col-3">
            <label htmlFor="comparisonPrice" className="visually-hidden">
              {" "}
              Jämförspris{" "}
            </label>
            <input
              ...
              id="comparisonPrice"
              className={`form-control form-control-sm ${
                formik.touched.comparisonPrice
                  ? formik.errors.comparisonPrice
                    ? "is-invalid"
                    : "is-valid"
                  : ""
              }`}
              placeholder={
                product ? `${product.comparisonPrice}` : "Jämförspris"
              }
              {...formik.getFieldProps("comparisonPrice")}
            />
        ...
        <div className="row justify-content-center align-items-center mb-2">
          <div className="col-10 ">
            ...
            <textarea
              ...
              placeholder={
                product ? `${product.description}` : "Produkt Beskrivning"
              }
        ...
        <div style={{ display: "flex", justifyContent: "space-around" }}>
          <button type="submit" className="btn btn-outline-primary font-bold">
            {" "}
